...
@Entity
@SequenceGenerator(name="logloc_seq",sequenceName="loglocacao_seq")
public class LogLocacao {
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="logloc_seq")
	private int id;
	@Column
